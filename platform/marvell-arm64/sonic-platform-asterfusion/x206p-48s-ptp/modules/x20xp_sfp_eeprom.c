...
#define MAX_PORT_NUM                54
#define MAX_10G_PORT_NUM            48
#define MAX_100G_PORT_NUM           6
...
QSFP_EEPROM_ATTR(49);QSFP_EEPROM_ATTR(50);QSFP_EEPROM_ATTR(51);QSFP_EEPROM_ATTR(52);QSFP_EEPROM_ATTR(53);QSFP_EEPROM_ATTR(54);
...
static struct bin_attribute *x20xp_xxs_sfp_eeprom_attributes[] = {
    ...
    &qsfp49_eeprom_attr, &qsfp50_eeprom_attr, &qsfp51_eeprom_attr, &qsfp52_eeprom_attr, &qsfp53_eeprom_attr, &qsfp54_eeprom_attr, 
    NULL
};
