...
i2c_topology_dict=[
    # cpld
    {'bus': "i2c-0", 'driver' : "pca9548", 'address': "0x75"},
    {'bus': "i2c-0", 'driver' : "8a34000", 'address': "0x58"},
    {'bus': "i2c-7", 'driver' : "24c64", 'address': "0x53"},
    {'bus': "i2c-4", 'driver' : "zrh2800k2", 'address': "0x5a"},
    {'bus': "i2c-5", 'driver' : "zrh2800k2", 'address': "0x59"},
    {'bus': "i2c-6", 'driver' : "x20xp_cpld", 'address': "0x40"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x70"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x71"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x72"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x73"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x74"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x75"},
    {'bus': "i2c-1", 'driver' : "x20xp_cpld", 'address': "0x76"},
    {'bus': "i2c-1", 'driver' : "x20xp_sfp_eeprom", 'address': "0x50"},
    {'bus': "i2c-1", 'driver' : "x20xp_sfp_status", 'address': "0x20"}
]


def doInstall():
    print("begin do Install ...")
