...
class Thermal(ThermalBase):
    ...
    def __init__(self, index):
        self.__index = index
        #thermal name list
        self.__thermal_name_list = ["switch_lm75", "cpu_lm75", "fan_lm75_left", "fan_lm75_right"]
        ...
        self.__temperature_attr = "/sys/bus/i2c/devices/6-0040/X20XP_Sensor/"+self.thermal_name
