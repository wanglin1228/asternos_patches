...
i2c_topology_dict=[
    ...
    {'bus': "i2c-0/0-0075/channel-2", 'driver' : "optoe2", 'address': "0x50"},
    {'bus': "i2c-0/0-0075/channel-3", 'driver' : "optoe2", 'address': "0x50"},
    {'bus': "i2c-0/0-0075/channel-5", 'driver' : "24c64", 'address': "0x50"}
]
...
def doInstall():
	...
	status, output = common.doBash("modprobe x102s_xgt")
