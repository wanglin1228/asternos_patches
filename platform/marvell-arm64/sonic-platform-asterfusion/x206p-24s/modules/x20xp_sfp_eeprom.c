...
QSFP_EEPROM_ATTR(25);QSFP_EEPROM_ATTR(26);QSFP_EEPROM_ATTR(27);QSFP_EEPROM_ATTR(28);QSFP_EEPROM_ATTR(29);QSFP_EEPROM_ATTR(30);
...
static struct bin_attribute *x20xp_xxs_sfp_eeprom_attributes[] = {
    ...
    &qsfp25_eeprom_attr, &qsfp26_eeprom_attr, &qsfp27_eeprom_attr, &qsfp28_eeprom_attr, &qsfp29_eeprom_attr, &qsfp30_eeprom_attr,
    NULL
};
