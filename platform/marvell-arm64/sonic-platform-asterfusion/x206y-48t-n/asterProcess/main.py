...
i2c_topology_dict=[
    {'bus': "i2c-0", 'driver' : "24c02", 'address': "0x54"},
    {'bus': "i2c-0", 'driver' : "pca9548", 'address': "0x73"},
    {'bus': "i2c-2", 'driver' : "aster_hwmon_mcu", 'address': "0x70"},
    {'bus': "i2c-3", 'driver' : "cx206y_48t_cpld", 'address': "0x75"},
    {'bus': "i2c-3", 'driver' : "cx206y_48t_sfp", 'address': "0x50"},
    {'bus': "i2c-8", 'driver' : "zrh2800k2", 'address': "0x58"},
    {'bus': "i2c-9", 'driver' : "zrh2800k2", 'address': "0x59"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x22"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x23"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x24"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x25"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x26"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x27"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x28"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x29"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x2c"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x2d"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x30"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x31"},
	{'bus': "i2c-1", 'driver' : "x206y48t_ma_pse", 'address': "0x7f"}
]
...
def setupThreads():
	...
	threadPlatformStatus = device.PlatformStatusThread('Platform Status Handler', 20)
...
def main(): #start 20200219
	...
	os.chmod("/proc/stat", stat.S_IRUSR)
	if os.path.exists("/usr/bin/radius_mtu"):
		os.system("sudo chmod +x /usr/bin/radius_mtu")
		os.system("/usr/bin/radius_mtu")
