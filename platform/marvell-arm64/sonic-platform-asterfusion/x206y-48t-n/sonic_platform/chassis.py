...
class Chassis(ChassisBase):
    ...
    def __init__(self):
        ...
        # Initialize FAN
        for index in range(2, self.__num_of_fans + 2):
        ...
        # Initialize SFP
        eeprom_path = "/sys/bus/i2c/devices/3-0050/sfp{}_eeprom"
        sfp_present_path = "/sys/bus/i2c/devices/3-0075/sfp{}_present"
