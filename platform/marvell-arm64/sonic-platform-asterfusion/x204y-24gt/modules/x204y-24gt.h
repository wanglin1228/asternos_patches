...
static struct i2c_client *x204y_24gt_i2c_client; //0x40 for cpld
...
/* i2c-0 */
static struct attribute *X204Y_24GT_SYS_attributes[] =
{
...
static struct attribute *X204Y_24GT_SFP_attributes[] =
{
...
static struct attribute *X204Y_24GT_Reset_attributes[] =
{
...
static struct attribute *X204Y_24GT_FAN_attributes[] = {
...
static struct attribute *X204Y_24GT_Sensor_attributes[] =
{
    &sensor_dev_attr_ac5x_lm75.dev_attr.attr,
    NULL
};

static struct attribute *X204Y_24GT_Led_attributes[] =
{
...
static const struct attribute_group X204Y_24GT_SYS_group =
{
    .name  = "X204Y_24GT_SYS",
    .attrs = X204Y_24GT_SYS_attributes,
};

static const struct attribute_group X204Y_24GT_Reset_group =
{
    .name  = "X204Y_24GT_Reset",
    .attrs = X204Y_24GT_Reset_attributes,
};

static const struct attribute_group X204Y_24GT_Sensor_group =
{
    .name  = "X204Y_24GT_Sensor",
    .attrs = X204Y_24GT_Sensor_attributes,
};

static const struct attribute_group X204Y_24GT_Led_group =
{
    .name  = "X204Y_24GT_Led",
    .attrs = X204Y_24GT_Led_attributes,
};

static const struct attribute_group X204Y_24GT_SFP_group =
{
    .name  = "X204Y_24GT_SFP",
    .attrs = X204Y_24GT_SFP_attributes,
};


static const struct attribute_group X204Y_24GT_FAN_group =
{
    .name  = "X204Y_24GT_FAN",
    .attrs = X204Y_24GT_FAN_attributes,
};
