...
class Thermal(ThermalBase):
    ...
    def __init__(self, index):
        self.__index = index
        #thermal name list
        self.__thermal_name_list = [ "LM75BD / CPU side",
                                     "LM75BD / Switch side"]
        ...
        if (index == 0):
            self.__temperature_attr = "/sys/bus/i2c/devices/0-0048/hwmon/hwmon2/temp1_input"
        else:
            self.__temperature_attr = "/sys/bus/i2c/devices/0-004f/hwmon/hwmon3/temp1_input"
