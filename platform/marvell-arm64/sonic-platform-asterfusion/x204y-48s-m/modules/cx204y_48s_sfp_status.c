             ...
             char *buf)
{
	...
	asterfusion_cx204y_48s_cpld_write(reg, SFP_SCL_BASE, data);
...
SFP_STATUS_ATTR(46);SFP_STATUS_ATTR(47);SFP_STATUS_ATTR(48);SFP_STATUS_ATTR(49);SFP_STATUS_ATTR(50);SFP_STATUS_ATTR(51);SFP_STATUS_ATTR(52);

static struct attribute *cx204y_48s_sfp_status_attributes[] = {
    ...
    &sensor_dev_attr_sfp49_tx_ctrl.dev_attr.attr,
    &sensor_dev_attr_sfp49_rx_loss.dev_attr.attr,

	&sensor_dev_attr_sfp50_present.dev_attr.attr,
    &sensor_dev_attr_sfp50_tx_ctrl.dev_attr.attr,
    &sensor_dev_attr_sfp50_rx_loss.dev_attr.attr,

	&sensor_dev_attr_sfp51_present.dev_attr.attr,
    &sensor_dev_attr_sfp51_tx_ctrl.dev_attr.attr,
    &sensor_dev_attr_sfp51_rx_loss.dev_attr.attr,

	&sensor_dev_attr_sfp52_present.dev_attr.attr,
    &sensor_dev_attr_sfp52_tx_ctrl.dev_attr.attr,
    &sensor_dev_attr_sfp52_rx_loss.dev_attr.attr,
    NULL
};

static const struct attribute_group cx204y_48s_sfp_status_group = { .attrs = cx204y_48s_sfp_status_attributes};

static int cx204y_48s_sfp_status_device_probe(struct i2c_client *client, const struct i2c_device_id *dev_id)
{
    int status;
    ...
    switch(client->addr)
    {
        case SFP_STATUS_ADDR:
            status = sysfs_create_group(&client->dev.kobj, &cx204y_48s_sfp_status_group);
            break;
...
static int cx204y_48s_sfp_status_device_remove(struct i2c_client *client)
{
    switch(client->addr)
    {
        case SFP_STATUS_ADDR:
            sysfs_remove_group(&client->dev.kobj, &cx204y_48s_sfp_status_group);
            break;
...
static const struct i2c_device_id cx204y_48s_sfp_status_id[] = {
    { "cx204y_48s_sfp2", 0 },
    {}
};
MODULE_DEVICE_TABLE(i2c, cx204y_48s_sfp_status_id);

static struct i2c_driver cx204y_48s_sfp_status_driver = {
    .driver = {
        .name     = "cx204y_48s_sfp2",
    },
    .probe        = cx204y_48s_sfp_status_device_probe,
    .remove       = cx204y_48s_sfp_status_device_remove,
    .id_table     = cx204y_48s_sfp_status_id,
};

static int __init cx204y_48s_sfp_status_init(void)
{
	return i2c_add_driver(&cx204y_48s_sfp_status_driver);
}

static void __exit cx204y_48s_sfp_status_exit(void)
{
	i2c_del_driver(&cx204y_48s_sfp_status_driver);
}

MODULE_AUTHOR("Wang Lin <wanglin@asterfusion.com>");
MODULE_DESCRIPTION("cx204y_48s_sfp_status driver");
MODULE_LICENSE("GPL");

module_init(cx204y_48s_sfp_status_init);
module_exit(cx204y_48s_sfp_status_exit);
