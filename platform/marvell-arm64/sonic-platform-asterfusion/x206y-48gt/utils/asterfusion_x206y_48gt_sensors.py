...
PSU_LIST = {
    0: ['PSU1', '/sys/bus/i2c/devices/5-0059/', '/sys/bus/i2c/devices/6-0040/X206Y_48GT_PSU/psu1_present'],
    1: ['PSU2', '/sys/bus/i2c/devices/4-0058/', '/sys/bus/i2c/devices/6-0040/X206Y_48GT_PSU/psu2_present']
}

FAN_LIST  = ['fan1_outlet_rpm', 'fan1_inlet_rpm', 'fan2_outlet_rpm', 'fan2_inlet_rpm', 'fan3_outlet_rpm', 'fan3_inlet_rpm']
TEMP_LIST = ['ac5x_lm75', 'fan_lm75_left', 'fan_lm75_right']
