 ...
 */
static const unsigned short normal_i2c[] = { CPLD_ADDRESS, PCA9548_0X73, PCA9548_0X74, PCA9548_0X75, PCA9548_0X76, I2C_CLIENT_END };
...
int asterfusion_x20xp_cpld_reset(void)
{
    ...
    for(sfpBase = PCA9548_0X73; sfpBase < PCA9548_0X76 + 1; sfpBase++)
    { 
