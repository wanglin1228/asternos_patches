 ...
 */
static const unsigned short normal_i2c[] = { CPLD_ADDRESS, PCA9548_0X73, PCA9548_0X74, PCA9548_0X76, I2C_CLIENT_END };
...
int asterfusion_x20xp_cpld_reset(void)
{
    ...
    asterfusion_x20xp_cpld_write(PCA9548_0X73, SFP_SCL_BASE, 0);
    asterfusion_x20xp_cpld_write(PCA9548_0X74, SFP_SCL_BASE, 0);
