...
static struct i2c_client *x104s_xgt_i2c_client; //0x40 for cpld
...
/* i2c-0 */
static struct attribute *X104S_XGT_SYS_attributes[] =
{
...
static struct attribute *X104S_XGT_SFP_attributes[] =
{
...
static struct attribute *X104S_XGT_Reset_attributes[] =
{
...
static struct attribute *X104S_XGT_FAN_attributes[] = {
...
static struct attribute *X104S_XGT_Sensor_attributes[] =
{
    &sensor_dev_attr_ac5x_lm75.dev_attr.attr,
    NULL
};

static struct attribute *X104S_XGT_Led_attributes[] =
{
...
static const struct attribute_group X104S_XGT_SYS_group =
{
    .name  = "X104S_XGT_SYS",
    .attrs = X104S_XGT_SYS_attributes,
};

static const struct attribute_group X104S_XGT_Reset_group =
{
    .name  = "X104S_XGT_Reset",
    .attrs = X104S_XGT_Reset_attributes,
};

static const struct attribute_group X104S_XGT_Sensor_group =
{
    .name  = "X104S_XGT_Sensor",
    .attrs = X104S_XGT_Sensor_attributes,
};

static const struct attribute_group X104S_XGT_Led_group =
{
    .name  = "X104S_XGT_Led",
    .attrs = X104S_XGT_Led_attributes,
};

static const struct attribute_group X104S_XGT_SFP_group =
{
    .name  = "X104S_XGT_SFP",
    .attrs = X104S_XGT_SFP_attributes,
};


static const struct attribute_group X104S_XGT_FAN_group =
{
    .name  = "X104S_XGT_FAN",
    .attrs = X104S_XGT_FAN_attributes,
};
