...
#define UART_TTYS1_SIRQ		(11)   /* /dev/ttyS1 */
...
#endif
static int aster_cx532p_fl00e02_probe(struct i2c_client *client, const struct i2c_device_id *dev_id)
{
...
static int aster_cx532p_fl00e02_remove(struct i2c_client *client)
{
...
static const struct i2c_device_id aster_cx532p_fl00e02_i2c_id[] =
{
    { "FL00E02_CPLD_40", 0 },
    {},
};
MODULE_DEVICE_TABLE(i2c, aster_cx532p_fl00e02_i2c_id);

static struct i2c_driver aster_cx532p_fl00e02_driver =
{
    .class        = I2C_CLASS_HWMON,
    .driver =
    {
        .name     = "CX532P_N_FL00E02",
    },
    .probe        = aster_cx532p_fl00e02_probe,
    .remove       = aster_cx532p_fl00e02_remove,
    .id_table     = aster_cx532p_fl00e02_i2c_id,
    .address_list = normal_i2c,
};

/*For main Switch board*/
static struct i2c_board_info aster_cx532p_fl00e02_CPLD_40_info[] __initdata =
{
    {
        I2C_BOARD_INFO("FL00E02_CPLD_40", CX532P_N_CPLD_1),
        .platform_data = NULL,
    },
};

static int __init aster_cx532p_fl00e02_init(void)
{
    int ret;
    ...
    aster_CPLD_40_client = i2c_new_client_device(i2c_adap_40, &aster_cx532p_fl00e02_CPLD_40_info[0]);
    ...
    ret = i2c_add_driver(&aster_cx532p_fl00e02_driver);
    printk(KERN_ALERT "CX532P-N i2c Driver Version: %s\n", DRIVER_VERSION);
    printk(KERN_ALERT "CX532P-N i2c Driver INSTALL SUCCESS(%d)\n", ret);
    return ret;
}

static void __exit aster_cx532p_fl00e02_exit(void)
{
    i2c_unregister_device(aster_CPLD_40_client);
    i2c_del_driver(&aster_cx532p_fl00e02_driver);
    printk(KERN_ALERT "CX532P-N Driver UNINSTALL SUCCESS\n");
}

module_init(aster_cx532p_fl00e02_init);
module_exit(aster_cx532p_fl00e02_exit);
