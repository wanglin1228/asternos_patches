...
BMC_SYSFILE_PATH            = '/sys/class/hwmon/hwmon1/device/CX532P_SYS/'
FAN_SYSFILE_PATH            = '/sys/class/hwmon/hwmon1/device/CX532P_FAN/'
POWER_SYSFILE_PATH          = '/sys/class/hwmon/hwmon1/device/CX532P_PSU/'
THERMAL_SYSFILE_PATH        = '/sys/class/hwmon/hwmon1/device/CX532P_THERMAL/'
