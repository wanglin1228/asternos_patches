...
int uart_write_cmd(u8 cmd, u8 sub_cmd_1, u8 sub_cmd_2, u8 n_para)
{
	...
	enable_irq(Asterfusion_Uart->sirq);
...
static int Asterfusion_cx308p_e03_device_probe(struct i2c_client *client, const struct i2c_device_id *dev_id)
{
...
static int Asterfusion_cx308p_e03_device_remove(struct i2c_client *client)
{
...
static const struct i2c_device_id Asterfusion_cx308p_e03_i2c_id[] =
{
    { "CX308P_e03_i2c", 2 },
    {},
};
MODULE_DEVICE_TABLE(i2c, Asterfusion_cx308p_e03_i2c_id);

static struct i2c_driver Asterfusion_cx308p_e03_i2c_driver =
{
    ...
    .probe        = Asterfusion_cx308p_e03_device_probe,
    .remove       = Asterfusion_cx308p_e03_device_remove,
    .id_table     = Asterfusion_cx308p_e03_i2c_id,
    .address_list = normal_i2c,
};

static struct i2c_board_info CX308P_e03_i2c_info[] __initdata =
{
    {
        I2C_BOARD_INFO("CX308P_e03_i2c", 0x40),
        .platform_data = NULL,
    },
};


static int __init Asterfusion_cx308p_e03_module_init(void)
{
    int ret;
    ...
    CX_308P_i2c_client = i2c_new_client_device(i2c_adap, &CX308P_e03_i2c_info[0]);
    ...
    ret = i2c_add_driver(&Asterfusion_cx308p_e03_i2c_driver);
    printk(KERN_ALERT "CX308P-48Y-N i2c Driver Version: %s\n", DRIVER_VERSION);
    printk(KERN_ALERT "CX308P-48Y-N i2c Driver INSTALL SUCCESS\n");
    return ret;
}

static void __exit Asterfusion_cx308p_e03_module_exit(void)
{
	i2c_unregister_device(CX_308P_i2c_client);
    i2c_del_driver(&Asterfusion_cx308p_e03_i2c_driver);
 ...
 */
module_init(Asterfusion_cx308p_e03_module_init);
module_exit(Asterfusion_cx308p_e03_module_exit);
