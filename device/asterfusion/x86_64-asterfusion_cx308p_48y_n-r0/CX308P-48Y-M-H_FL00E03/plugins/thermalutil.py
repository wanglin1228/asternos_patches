...
class ThermalUtil(ThermalBase):
    ...
    def __init__(self):
        ...
        self.thermal_device_path = "/sys/class/hwmon/hwmon3/device/CX308P_THERMAL/"
        ...
        self.index_to_temp_mapping = {
            ...
            4: ['THERMAL_1', 'thermal_sersor_1'],
            5: ['THERMAL_2', 'thermal_sersor_2'],
            6: ['THERMAL_3', 'thermal_sersor_3'],
            7: ['THERMAL_4', 'thermal_sersor_4']
        }
        core_count = 0
        for i in range(2,20):
            if core_count == 2:
