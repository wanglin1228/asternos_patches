...
class ThermalUtil(ThermalBase):
    ...
    def __init__(self):
        ...
        self.thermal_core_path = "/sys/devices/platform/coretemp.0/hwmon/hwmon2/"
        self.thermal_device_path = "/sys/class/hwmon/hwmon3/device/CX532P_THERMAL/"
        ...
        self.index_to_temp_mapping = {
            ...
            4: ['Left_Main_Board', 'cpu_l_temp'],
            5: ['Right_Main_Board', 'cpu_r_temp'],
            6: ['Left_Fan_Board', 'fan_1_temp'],
            7: ['Right_Fan_Board', 'fan_2_temp'],
            8: ['Temp', 'temp'],
        }
        core_count = 0
        for i in range(2,20):
